...
export default function AvailableAppStore() {
    return(
        <a href="https://apps.apple.com/us/app/emerald-capital/id6743625956?uo=2" target="_blank" className="flex items-center gap-3 bg-white px-5 py-2 rounded-lg select-none cursor-pointer hover:shadow-lg hover:bg-neutral-200 duration-200">
