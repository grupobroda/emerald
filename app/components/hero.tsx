...
export default function Hero() {
    return(
        <section className="flex flex-col gap-10 items-center justify-center w-screen h-screen from-[#034941] to-[#023932] bg-clip-content bg-gradient-to-r">
            <h1 className="text-white text-8xl font-bold w-[60%] text-center md:text-5xl">Tus finanzas al día, con <span className="from-[#2dccb1] to-[#218F7F] bg-gradient-to-r bg-clip-text text-transparent">Emerald Capital</span>.</h1>
            <div className="inline-flex gap-5 md:flex-col">
