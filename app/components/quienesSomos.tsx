...
export default function QuienesSomos() {
    return (
        <section className="flex flex-col gap-20 p-20 pt-30 px-80" id="quienesSomos">
            ...
            <div className="grid grid-cols-4 gap-10">
                {INTEGRANTES_EQUIPO.map((integrante)=> {
                    return(
                        <article key={integrante.nombre} className="bg-neutral-500 rounded-lg w-full h-[300px] relative bg-cover bg-center bg-no-repeat overflow-hidden group" style={{backgroundImage: `url(${integrante.foto})`}}>
                            ...
                            <a href={integrante.linkedin} target="_blank" className="absolute right-3 -top-10 group-hover:top-3 duration-200">
                                <LinkedinIcon/>
                            </a>
                        </article>
                    )
